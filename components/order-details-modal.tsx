  ...
  const getItemsTotal = () =>
    order.items.reduce((total, item) => {
      if ("product" in item) {
        ...
        // safer fallback if products is missing or empty
        const bundleTotal =
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex justify-between text-sm">
              <span>Subtotal</span>
              <span className="font-medium">KD {getItemsTotal().toFixed(2)}</span>
            </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <Separator />
            <p className="text-sm flex gap-1 items-center text-gray-700">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            {order.items.map((item, index) => {
              ...
              const img = isProject
                ? item.products?.[0]?.image?.split(",")[0] ?? "/amtronics-logo.webp"
